...
const PatientForm: React.FC = () => {
  ...
  try {
    setLoading(true);
    const promise = method(url, patientData);
  ...
  return (
    <div className="bg-white p-6 sm:p-8 rounded-xl shadow-md max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
         <div>
                  <label htmlFor="idPasien" className="block text-sm font-semibold text-brand-text-secondary mb-2">
                    ID PASIEN
                  </label>
    ...
    : isEdit ? 'Update Data Pasien' : 'Simpan Data Pasien'}
          </button>
        </div>
      </form>
    </div>
